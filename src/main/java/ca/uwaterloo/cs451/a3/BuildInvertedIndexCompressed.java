...
public class BuildInvertedIndexCompressed extends Configured implements Tool {
    ...
    private static final class MyReducer extends
        ...
        private static final Text PREV = new Text();
        ...
        public void reduce(PairOfStringInt key, Iterable<IntWritable> values, Context context)
            ...
            if (key.getRightElement() == -1) {
                if (!PREV.toString().equals("null")) {
                    context.write(PREV, new BytesWritable(BYTESTREAM.toByteArray()));
                    BYTESTREAM.reset();
                    DATASTREAM.flush();
                    prevId = 0;
                }
                ...
                while(iter.hasNext()) {
                    WritableUtils.writeVInt(DATASTREAM, docId - prevId);
